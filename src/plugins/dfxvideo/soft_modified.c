 ...
 ***************************************************************************/
#ifdef ASMJS_HACK
#define __W(stmt) { uint32_t tmp=psxVuw[(i<<10)+j+1]; \
      uint32_t * tmp_ptr = &tmp; \
      tmp = (tmp<<16)|psxVuw[(i<<10)+j]; \
      stmt; \
      psxVuw[(i<<10)+j]=tmp&0xffff;\
      psxVuw[(i<<10)+j+1]=tmp>>16;}

#define __W2(stmt) { uint32_t tmp=psxVuw[sprA+1]; \
      uint32_t * tmp_ptr = &tmp; \
      tmp = (tmp<<16)|psxVuw[sprA]; \
      stmt; \
      psxVuw[sprA]=tmp&0xffff;\
      psxVuw[sprA+1]=tmp>>16;}
#else
#define __W(stmt) { uint32_t *tmp_ptr=(uint32_t *)(&psxVuw[(i<<10)+j]); \
      stmt; }

#define __W2(stmt) { uint32_t *tmp_ptr=(uint32_t *)(&psxVuw[sprA]); \
      stmt; }
#endif
#define _IN_SOFT
...
__inline static void GetShadeTransCol_Dither(unsigned short * pdest, int32_t m1, int32_t m2, int32_t m3)
{
 int32_t r,g,b;
...
__inline static void GetShadeTransCol(unsigned short * pdest,unsigned short color)
{
 if(bCheckMask && (*pdest & HOST2LE16(0x8000))) return;
...
__inline static void GetShadeTransCol32(uint32_t * pdest,uint32_t color)
{
 if(DrawSemiTrans)
  {
   int32_t r,g,b;
...
__inline static void GetTextureTransColG(unsigned short * pdest,unsigned short color)
{
...
__inline static void GetTextureTransColG_S(unsigned short * pdest,unsigned short color)
{
 int32_t r,g,b;unsigned short l;
...
__inline static void GetTextureTransColG_SPR(unsigned short * pdest,unsigned short color)
{
 int32_t r,g,b;unsigned short l;
...
__inline static void GetTextureTransColG32(uint32_t * pdest,uint32_t color)
{
 int32_t r,g,b,l;
...
__inline static void GetTextureTransColG32_S(uint32_t * pdest,uint32_t color)
{
 int32_t r,g,b;
...
__inline static void GetTextureTransColG32_SPR(uint32_t * pdest,uint32_t color)
{
 int32_t r,g,b;
...
__inline static void GetTextureTransColGX_Dither(unsigned short * pdest,unsigned short color,int32_t m1,int32_t m2,int32_t m3)
{
 int32_t r,g,b;
...
__inline static void GetTextureTransColGX(unsigned short * pdest,unsigned short color,short m1,short m2,short m3)
{
 int32_t r,g,b;unsigned short l;
...
__inline static void GetTextureTransColGX_S(unsigned short * pdest,unsigned short color,short m1,short m2,short m3)
{
 int32_t r,g,b;
...
__inline static void GetTextureTransColGX32_S(uint32_t * pdest,uint32_t color,short m1,short m2,short m3)
{
 int32_t r,g,b;
   ...
   if(!bCheckMask && !DrawSemiTrans)
   ...
   else
    {
     for(i=0;i<dy;i++)
      {
       for(j=0;j<dx;j++){
        uint32_t tmp=DSTPtr[1];
        tmp = (tmp<<16)|DSTPtr[0];
        GetShadeTransCol32(&tmp,lcol);
        DSTPtr[0]=tmp&0xffff;
        DSTPtr[1]=tmp>>16;
        DSTPtr+=2;
       }
...
__inline static int shl10idiv(int x, int y)
{
 __int64 bi=x;
 bi<<=10;
 return bi/y;
...
__inline static int RightSection_F(void)
{
...
__inline static int LeftSection_F(void)
{
...
__inline static BOOL NextRow_F(void)
{
...
__inline static BOOL SetupSections_F(short x1, short y1, short x2, short y2, short x3, short y3)
{
...
__inline static int RightSection_G(void)
{
 soft_vertex * v1 = right_array[ right_section ];
 soft_vertex * v2 = right_array[ right_section-1 ];
...
__inline static int LeftSection_G(void)
{
 soft_vertex * v1 = left_array[ left_section ];
 soft_vertex * v2 = left_array[ left_section-1 ];
...
__inline static BOOL NextRow_G(void)
{
 if(--left_section_height<=0) 
  {
   if(--left_section <= 0) {return TRUE;}
...
__inline static BOOL SetupSections_G(short x1,short y1,short x2,short y2,short x3,short y3,int32_t rgb1, int32_t rgb2, int32_t rgb3)
{
 soft_vertex * v1, * v2, * v3;
...
__inline static int RightSection_FT(void)
{
 soft_vertex * v1 = right_array[ right_section ];
 soft_vertex * v2 = right_array[ right_section-1 ];
...
__inline static int LeftSection_FT(void)
{
 soft_vertex * v1 = left_array[ left_section ];
 soft_vertex * v2 = left_array[ left_section-1 ];
...
__inline static BOOL NextRow_FT(void)
{
 if(--left_section_height<=0) 
  {
   if(--left_section <= 0) {return TRUE;}
...
__inline static BOOL SetupSections_FT(short x1, short y1, short x2, short y2, short x3, short y3, short tx1, short ty1, short tx2, short ty2, short tx3, short ty3)
{
 soft_vertex * v1, * v2, * v3;
 int height,longest,temp;
...
__inline static int RightSection_GT(void)
{
 soft_vertex * v1 = right_array[ right_section ];
 soft_vertex * v2 = right_array[ right_section-1 ];
...
__inline static int LeftSection_GT(void)
{
 soft_vertex * v1 = left_array[ left_section ];
 soft_vertex * v2 = left_array[ left_section-1 ];
...
__inline static BOOL NextRow_GT(void)
{
 if(--left_section_height<=0) 
  {
   if(--left_section <= 0) {return TRUE;}
...
__inline static BOOL SetupSections_GT(short x1, short y1, short x2, short y2, short x3, short y3, short tx1, short ty1, short tx2, short ty2, short tx3, short ty3, int32_t rgb1, int32_t rgb2, int32_t rgb3)
{
 soft_vertex * v1, * v2, * v3;
 int height,longest,temp;
...
__inline static int RightSection_F4(void)
{
 soft_vertex * v1 = right_array[ right_section ];
 soft_vertex * v2 = right_array[ right_section-1 ];
...
__inline static int LeftSection_F4(void)
{
 soft_vertex * v1 = left_array[ left_section ];
 soft_vertex * v2 = left_array[ left_section-1 ];
...
__inline static BOOL NextRow_F4(void)
{
 if(--left_section_height<=0) 
  {
   if(--left_section > 0) 
...
__inline static BOOL SetupSections_F4(short x1, short y1, short x2, short y2, short x3, short y3, short x4, short y4)
{
...
__inline static int RightSection_FT4(void)
{
 soft_vertex * v1 = right_array[ right_section ];
 soft_vertex * v2 = right_array[ right_section-1 ];
...
__inline static int LeftSection_FT4(void)
{
 soft_vertex * v1 = left_array[ left_section ];
 soft_vertex * v2 = left_array[ left_section-1 ];
...
__inline static BOOL NextRow_FT4(void)
{
 if(--left_section_height<=0) 
  {
   if(--left_section > 0) 
...
__inline static BOOL SetupSections_FT4(short x1, short y1, short x2, short y2, short x3, short y3, short x4, short y4, short tx1, short ty1, short tx2, short ty2, short tx3, short ty3, short tx4, short ty4)
{
 soft_vertex * v1, * v2, * v3, * v4;
 int height,width,longest1,longest2;
...
__inline static int RightSection_GT4(void)
{
 soft_vertex * v1 = right_array[ right_section ];
 soft_vertex * v2 = right_array[ right_section-1 ];
...
__inline static int LeftSection_GT4(void)
{
 soft_vertex * v1 = left_array[ left_section ];
 soft_vertex * v2 = left_array[ left_section-1 ];
...
__inline static BOOL NextRow_GT4(void)
{
 if(--left_section_height<=0) 
  {
   if(--left_section > 0) 
...
__inline static BOOL SetupSections_GT4(short x1, short y1, short x2, short y2, short x3, short y3, short x4, short y4, short tx1, short ty1, short tx2, short ty2, short tx3, short ty3, short tx4, short ty4,int32_t rgb1,int32_t rgb2,int32_t rgb3,int32_t rgb4)
{
 soft_vertex * v1, * v2, * v3, * v4;
 int height,width,longest1,longest2;
...
__inline static void drawPoly3Fi(short x1,short y1,short x2,short y2,short x3,short y3,int32_t rgb)
{
 ...
 for (i=ymin;i<=ymax;i++)
  {
   ...
   for(j=xmin;j<xmax;j+=2) 
    {    
     __W(GetShadeTransCol32(tmp_ptr,lcolor));
    }
   if(j==xmax)
     ...
     if(xmax>=xmin)
      {
       ...
       for(j=xmin;j<xmax;j+=2)
        ...
        __W(GetTextureTransColG32_S(tmp_ptr,
       ...
       for(j=xmin;j<xmax;j+=2)
        {
         ...
         tC2=(tC2>>((XAdjust&1)<<2))&0xf;
__W(
         GetTextureTransColG32_S(tmp_ptr,
             GETLE16(&psxVuw[clutP+tC1])|
             ((int32_t)GETLE16(&psxVuw[clutP+tC2]))<<16));
     ...
     for(j=xmin;j<xmax;j+=2)
      {
       ...
       tC2=(tC2>>((XAdjust&1)<<2))&0xf;
__W(
       GetTextureTransColG32_SPR(tmp_ptr,
            GETLE16(&psxVuw[clutP+tC1])|
            ((int32_t)GETLE16(&psxVuw[clutP+tC2]))<<16));
       posX+=difX2;
       posY+=difY2;
     ...
     for(j=xmin;j<xmax;j+=2)
      {
       ...
       tC2 = psxVub[(((posY+difY)>>5)&(int32_t)0xFFFFF800)+YAdjust+
                     ((posX+difX)>>16)];
       __W(GetTextureTransColG32(tmp_ptr,
            GETLE16(&psxVuw[clutP+tC1])|
            ((int32_t)GETLE16(&psxVuw[clutP+tC2]))<<16));
       posX+=difX2;
       posY+=difY2;
     ...
     for(j=xmin;j<xmax;j+=2)
      {
       ...
       tC2 = psxVub[((((posY+difY)>>16)%TWin.Position.y1)<<11)+
                     YAdjust+(((posX+difX)>>16)%TWin.Position.x1)];
       __W(GetTextureTransColG32_SPR(tmp_ptr,
            GETLE16(&psxVuw[clutP+tC1])|
            ((int32_t)GETLE16(&psxVuw[clutP+tC2]))<<16));
       posX+=difX2;
       posY+=difY2;
...
__inline static void drawPoly3Gi(short x1,short y1,short x2,short y2,short x3,short y3,int32_t rgb1, int32_t rgb2, int32_t rgb3)
{
 int i,j,xmin,xmax,ymin,ymax;
 int32_t cR1,cG1,cB1;
       ...
       for(j=xmin;j<xmax;j+=2) 
        {
         ...
         __W(GetTextureTransColGX32_S(tmp_ptr,
               GETLE16(&psxVuw[clutP+tC1])|
               ((int32_t)GETLE16(&psxVuw[clutP+tC2]))<<16,
...
// real rect test
__inline static BOOL IsNoRect(void)
{
      ...
      for (sprCY=0;sprCY<sprtH;sprCY++)
       {
        ...
        for (sprCX=0;sprCX<sprtW;sprCX++,sprA+=2)
         { 
          ...
          __W2(GetTextureTransColG32_S(tmp_ptr,
    ...
    for (sprCY=0;sprCY<sprtH;sprCY++)
     {
      ...
      for (sprCX=0;sprCX<sprtW;sprCX++,sprA+=2)
       { 
        ...
        __W2(GetTextureTransColG32_SPR(tmp_ptr,
            (((int32_t)GETLE16(&psxVuw[clutP+((tC>>4)&0xf)])<<16))|
            GETLE16(&psxVuw[clutP+(tC&0x0f)])));
       }
